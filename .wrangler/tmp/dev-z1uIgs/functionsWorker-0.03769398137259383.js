...
// .wrangler/tmp/bundle-elFUFg/checked-fetch.js
...
// .wrangler/tmp/bundle-elFUFg/middleware-loader.entry.ts
var import_checked_fetch18 = __toESM(require_checked_fetch());

// wrangler-modules-watch:wrangler:modules-watch
var import_checked_fetch = __toESM(require_checked_fetch());

// .wrangler/tmp/bundle-elFUFg/middleware-insertion-facade.js
var import_checked_fetch16 = __toESM(require_checked_fetch());

// .wrangler/tmp/pages-ZwPsEW/functionsWorker-0.03769398137259383.mjs
...
var require_checked_fetch2 = __commonJS2({
  "../.wrangler/tmp/bundle-mhhPcK/checked-fetch.js"() {
    var urls = /* @__PURE__ */ new Set();
    function checkURL(request, init) {
      const url = request instanceof URL ? request : new URL(
        (typeof request === "string" ? new Request(request, init) : request).url
...
async function onRequest5({ request, env }) {
  ...
  try {
    ...
    const isValid = await verifyPassword2(password, adminUser.password);
    if (!isValid) {
      return new Response(JSON.stringify({ error: "Invalid admin credentials" }), { status: 401, headers });
    }
    return new Response(JSON.stringify({
...
async function onRequest6({ request, env }) {
  ...
  try {
    ...
    const tipos = {
      estudio: "Sesi\xF3n de Estudio",
      estudio_tematico: "Sesi\xF3n Tem\xE1tica",
      tecnica: "Fotograf\xEDa T\xE9cnica",
      boda: "Sesi\xF3n de Boda",
    ...
    <table style="border-collapse: collapse; width: 100%;">
      ...
      <tr><td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Tel\xE9fono</td><td style="padding: 8px; border: 1px solid #ddd;">${telefono}</td></tr>
      <tr><td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">Tipo de Sesi\xF3n</td><td style="padding: 8px; border: 1px solid #ddd;">${tipos[tipo_sesion] || tipo_sesion}</td></tr>
...
//# sourceMappingURL=functionsWorker-0.03769398137259383.js.map
